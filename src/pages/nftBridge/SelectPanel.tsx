...
const SelectPanel = () => {
  ...
  const getTokenURI = async () => {
    const uri = await instance721["tokenURI(uint256)"](0)
    console.log(uri, "uri")
  }
  ...
  const send721 = async () => {
    const tx = await instanceBridge721["depositERC721(address,address,uint256,uint256)"](L1_721, walletCurrentAddress, 0, 0)
    const txResult = await tx.wait()
