...
export default function Swap() {
  ...
  const { v1Trade, v2Trade, currencyBalances, parsedAmount, currencies, inputError: swapInputError } = useDerivedSwapInfo()
  ...
  }, [tradeToConfirm, walletCurrentAddress, priceImpactWithoutFee, recipient, recipientAddress, showConfirm, swapCallback, trade])
        ...
        <Wrapper id="swap-page">
          ...
          <AutoColumn gap={"md"}>
            ...
            <AutoColumn justify="space-between">
              <AutoRow justify={isExpertMode ? "space-between" : "center"} style={{ padding: "0 1.6rem" }}>
            ...
            {recipient !== null && !showWrap ? (
              <>
                <AutoRow justify="space-between" style={{ padding: "0 1.6rem" }}>
            ...
            {showWrap ? null : (
              <Card padding={".4rem 1.2rem 0 1.2rem"} borderRadius={"20px"}>
                <AutoColumn gap="4px">
                  {Boolean(trade) && (
          ...
          <BottomGrouping>
            {!walletCurrentAddress ? (
              <ButtonLight onClick={handleConnectWallet}>Connect Wallet</ButtonLight>
            ) : showWrap ? (
