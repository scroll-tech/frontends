...
export default function Pool() {
  ...
  const [v2PairsBalances, fetchingV2PairBalances] = useTokenBalancesWithLoadingIndicator(walletCurrentAddress ?? undefined, liquidityTokens)
    ...
    <>
      <AppBody>
        ...
        <AutoColumn gap="lg" justify="center">
          <ButtonPrimary id="join-pool-button" as={Link} style={{ padding: 16, color: "#fff" }} to="/add/ETH">
