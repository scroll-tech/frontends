  ...
  return (
    <AutoColumn gap="20px">
      ...
      <TYPE.darkGray style={{ textAlign: "center" }}>
        {`Your Uniswap V1 ${chainId && token.equals(WETH[chainId]) ? "WETH" : token.symbol}/ETH liquidity will be redeemed for underlying assets.`}
      </TYPE.darkGray>
    </AutoColumn>
  )
}
    ...
    <BodyWrapper style={{ padding: 24 }} id="remove-v1-exchange">
      <AutoColumn gap="16px">
        ...
        {!walletCurrentAddress ? (
          ...
          <V1PairRemoval exchangeContract={exchangeContract} liquidityTokenAmount={userLiquidityBalance} token={token} />
        ) : (
