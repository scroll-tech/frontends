...
import { Currency, ETHER, Percent, WETH, currencyEquals } from "uniswap-v2-sdk-scroll"
...
export default function RemoveLiquidity({
  ...
  async function onRemove() {
    if (!chainId || !provider || !walletCurrentAddress) throw new Error("missing dependencies")
  ...
  const pendingText = `Removing ${parsedAmounts[Field.CURRENCY_A]?.toSignificant(6)} ${currencyA?.symbol} and ${parsedAmounts[
    Field.CURRENCY_B
  ...
  return (
    <>
      ...
      {pair ? (
        <AutoColumn style={{ minWidth: "320rem", marginTop: "1.6rem" }}>
