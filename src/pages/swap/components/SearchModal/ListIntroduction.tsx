...
export default function ListIntroduction({ onSelectList }: { onSelectList: () => void }) {
  ...
  return (
    <Column style={{ width: "100%", flex: "1 1" }}>
      <PaddedColumn>
        <AutoColumn gap="14px">
          <img style={{ width: "120px", margin: "0 auto" }} src={isDark ? listDark : listLight} alt="token-list-preview" />
          <img
          ...
          <OutlineCard style={{ marginBottom: "8px", padding: "1.6rem" }}>
            <Text fontWeight={400} fontSize={14} style={{ textAlign: "center" }}>
              Token lists are an <ExternalLink href="https://github.com/uniswap/token-lists">open specification</ExternalLink>. Check out{" "}
