...
export function useUserHasLiquidityInAllTokens(): boolean | undefined {
  ...
  const balances = useTokenBalances(walletCurrentAddress ?? undefined, v1ExchangeLiquidityTokens)
...
export function isTradeBetter(tradeA: Trade | undefined, tradeB: Trade | undefined, minimumDelta: Percent = ZERO_PERCENT): boolean | undefined {
