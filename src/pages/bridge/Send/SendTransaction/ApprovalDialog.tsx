...
import { Avatar, Box, Card, Chip, List, ListItem, ListItemIcon, ListItemText, Stack, SvgIcon, Typography } from "@mui/material"
...
const ApprovalDialog = props => {
  ...
  return (
    <BridgeDialog open={open} onClose={onClose}>
      ...
      <Typography sx={{ fontSize: ["2rem", "2.4rem"], lineHeight: "3.2rem", fontWeight: 500 }}>Approve {token.symbol} token</Typography>
      <Typography sx={{ fontSize: ["2rem", "2.4rem"], lineHeight: "3.6rem", fontWeight: 600, textAlign: ["center", "left"] }}>
