...
const FAQ = () => {
  ...
  return (
    <div className={classes.wrapper}>
      ...
      <Accordion>
        <AccordionSummary expandIcon={<ExpandMoreIcon color="secondary" />} id="1">
        ...
        <AccordionDetails>
          ...
          <Typography variant="body1" color="textSecondary" className={classes.orderedParagraph}>
            1. Receive test tokens from the <Link href={SiteMap.Faucet}>Faucet</Link>, to the Scroll L1 network.
          </Typography>
          <Typography variant="body1" color="textSecondary" className={classes.orderedParagraph}>
      ...
      <Accordion>
        <AccordionSummary expandIcon={<ExpandMoreIcon color="secondary" />} id="2">
      ...
      <Accordion>
        <AccordionSummary expandIcon={<ExpandMoreIcon color="secondary" />} id="3">
          <Typography variant="h6">How to send tokens using the Bridge?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography variant="body1" color="textSecondary" className={classes.orderedParagraph}>
      ...
      <Accordion square>
        <AccordionSummary expandIcon={<ExpandMoreIcon color="secondary" />} id="4">
          <Typography variant="h6">Where can I find Scroll architecture overview?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography variant="body1" color="textSecondary">
