...
export default class Delaunator {
  ...
  _cx: any
  _cy: any
  private _hullStart: any
  trianglesLen: any

  static from(points: string | any[], getX = defaultGetX, getY = defaultGetY) {
  ...
  constructor(coords: string | any[] | Float64Array) {
  ...
  update() {
    ...
    this.halfedges = this._halfedges.subarray(0, this.trianglesLen) as any
  }
...
function orient(rx: any, ry: any, qx: any, qy: any, px: any, py: any) {
...
function swap(arr: any[] | Uint32Array, i: number, j: number) {
  const tmp = arr[i]
  arr[i] = arr[j]
  arr[j] = tmp
}
