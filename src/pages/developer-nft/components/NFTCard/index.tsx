    ...
    <Box sx={sx}>
      <svg width="100%" height="auto" style={{ aspectRatio: "312/366" }} viewBox="0 0 312 366" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          ...
          stroke-miterlimit="10"
        />
        <path d="M48.23 61.2L224.78 61.2V14.34L48.23 14.34V61.2Z" stroke="#050308" stroke-linecap="round" stroke-linejoin="round" />
        ...
        <g mask="url(#mask0_642_1648)">
          <path d="M-41.8801 84.5H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 101.85H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 119.21H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 136.56H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 153.92H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 171.27H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 188.62H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 205.98H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 223.33H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 240.68H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 258.04H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M-41.8801 275.39H310.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M238.39 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M221.04 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M203.68 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M186.33 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M168.98 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M151.62 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M134.27 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M116.92 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M99.5598 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M82.21 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M64.8499 -4.87988V347.41" stroke="#ECCCA2" stroke-width="0.25" stroke-linecap="round" stroke-linejoin="round" />
        ...
        <path d="M256.82 274.04V105.4L224.66 73.24H48.23V251.84L67.25 270.22" stroke="#050308" stroke-miterlimit="10" />
        <path d="M257 93.55L224.84 61.2V14.34L257 46.69V93.55Z" fill="#E8BE8B" stroke="#050308" stroke-linecap="round" stroke-linejoin="round" />
        ...
        <path d="M256.99 288.4H77.8301V313.99H256.99V288.4Z" fill="#ECCCA2" stroke="#050308" stroke-linecap="round" stroke-linejoin="round" />
        ...
        <defs>
          <linearGradient id="paint0_linear_642_1648" x1="35.56" y1="13.42" x2="-10.69" y2="55.28" gradientUnits="userSpaceOnUse">
            <stop offset="0.06" stop-color="#C49C70" />
            <stop offset="0.11" stop-color="#CBA478" />
            <stop offset="0.24" stop-color="#D9B68B" />
            <stop offset="0.39" stop-color="#E4C298" />
            <stop offset="0.59" stop-color="#EAC99F" />
            <stop offset="1" stop-color="#ECCCA2" />
          </linearGradient>
