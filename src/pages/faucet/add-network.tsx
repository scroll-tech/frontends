  ...
  return (
    <main className="h-[90vh]  flex justify-center items-center flex-col px-[16px]">
      ...
      <p className="max-w-[746px] text-center text-[16px] text-[#595959] leading-[26px]">
        ...
        a fork of Ethereum utilizing a PoA-based consensus, and a zero-knowledge
        rollup testnet deployed on top of the former.
      </p>
      ...
      <div className="w-[80%] flex justify-between items-center mt-[67px] max-w-[500px] md:w-full">
        ...
        >
          <img
            className="w-[13px]"
            alt="success"
            src="/imgs/faucet/success.png"
          />
        </div>
        <div
          className={`h-[1px] flex-1 ${
            step === ChainId.SCROLL_LAYER_1 ? "bg-[#E8E8E8]" : "bg-[#00C331]"
          }`}
        />
      ...
      <div className="flex mt-[65px] w-full max-w-[500px] justify-between">
        <div className="max-w-[180px] text-left text-[#333333]">
          Add {Addresses[step].autoconnect.chainName} to your Metamask networks
        </div>
        <button
      ...
      <div className="flex mt-[40px] w-full max-w-[500px] justify-between">
        <div className="max-w-[180px] text-left text-[#333333]">
          Add the {faucetInfo.usdcSymbol} token to{" "}
          ...
          <>
            <button className="flex justify-center items-center">
              ...
              <img
                ...
                alt="right arrow"
                src="/imgs/faucet/right-arrow.png"
              />
            </button>
            <button
