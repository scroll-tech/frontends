...
export default function CustomizedAccordions() {
  ...
  return (
    <div className="max-w-[920px] mx-auto mb-[20vh] text-left">
      <p className="font-display text-[#333] text-[28px] leading-[32px] md:text-[34px]">
        FAQs
      </p>
      <Accordion
          ...
          <div className="text-[16px] leading-[26px] pb-[40px] text-[#595959]">
            <ul className="pl-[20px] list-decimal">
              <li>
                <span
                  onClick={() =>
                    addToMetaMask(Addresses[ChainId.SCROLL_LAYER_1].autoconnect)
                  }
              ...
              <li>
                <span
                  onClick={() =>
                    addToMetaMask(Addresses[ChainId.SCROLL_LAYER_2].autoconnect)
                  }
                  className="link-button cursor-pointer"
                >
              ...
              <li>
                Click on the button ‘’Request Testnet Scroll tokens’’ and
                receive your testnet Scroll tokens (1ETH & 100 USDC) within a
                few seconds.
              </li>
              <li>
