...
import HaichenAvatar from "@/assets/svgs/members/Haichen-avatar.svg?url"
import SandyAvatar from "@/assets/svgs/members/Sandy-avatar.svg?url"
import YeAvatar from "@/assets/svgs/members/Ye-avatar.svg?url"
    ...
    <SectionWrapper maxWidth="127.5rem" sx={{ textAlign: "center", pb: "22rem" }}>
      <OrientationToView>
        ...
        <Typography sx={{ whiteSpace: "pre-wrap" }}>
          ...
          founders—
          <CoFounder>
            Ye <InlineAvater size={avatarSize} alt="Ye" src={YeAvatar.src} />
          </CoFounder>
          , a mathematician fascinated by zero knowledge proofs;{" "}
          <CoFounder>
            Haichen <InlineAvater size={avatarSize} alt="Haichen" src={HaichenAvatar.src} />
          </CoFounder>
          , a systems engineer drawn to cryptography; and{" "}
          <CoFounder>
            Sandy <InlineAvater size={avatarSize} alt="Sandy" src={SandyAvatar.src} />
          </CoFounder>
