 ...
 */
export function hasInjectedProvider({ flag, namespace }: { flag?: any; namespace?: string }): boolean {
...
export function getInjectedConnector({ flag, namespace, target }: { flag?: any; namespace?: string; target?: any }): any {
