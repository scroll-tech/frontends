...
export const ETH_SYMBOL = process.env.REACT_APP_ETH_SYMBOL as string;
const USDC_SYMBOL = process.env.REACT_APP_USDC_SYMBOL as string;
...
export const tokens = {
  ...
  [USDC_SYMBOL]: {
    ...
    decimals: 18,
    address: {
      [ChainId.SCROLL_LAYER_1]: "0xc00FbEf12f2f41dc36C3A928caD93E0C132A2B4B",
      [ChainId.SCROLL_LAYER_2]: "0x80732890c93c6D9c6C23E06F888eD0CB88A06018",
    },
    TokenImage:
