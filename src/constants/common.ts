...
export const L1_NAME = `Ethereum ${isMainnet ? "" : requireEnv("REACT_APP_SCROLL_ENVIRONMENT")}`

export const L2_NAME = `Scroll ${isMainnet ? "" : requireEnv("REACT_APP_SCROLL_ENVIRONMENT")}`
